...
object UrlDetection {
     ...
     */
    fun spliceUrl(text: String, oldUrl: String, newUrl: String): String {
        val index = text.indexOf(oldUrl)
        if (index == -1) return newUrl
        return text.substring(0, index) + newUrl + text.substring(index + oldUrl.length)
    }
}
