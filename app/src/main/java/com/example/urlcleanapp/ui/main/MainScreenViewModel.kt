...
import com.example.urlcleanapp.data.UrlExpander
...
class MainScreenViewModel(
    ...
    fun cleanUrl(url: String, isShared: Boolean = false, originalShortUrl: String? = null) {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                if (isShared) {
                    com.example.urlcleanapp.FlavorConfig.handleShareAutomation(result.cleanedUrl, settingsRepository) { autoClose ->
    ...
    fun copyToClipboard(context: Context) {
        ...
        if (cleaned.isNotEmpty()) {
            ...
            val clip = ClipData.newPlainText(context.getString(com.example.urlcleanapp.R.string.main_cleaned_url), cleaned)
            ...
            Toast.makeText(context, context.getString(com.example.urlcleanapp.R.string.toast_copied), Toast.LENGTH_SHORT).show()
        }
    }
