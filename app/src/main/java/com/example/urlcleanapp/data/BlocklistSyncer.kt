...
object BlocklistSyncer {
    suspend fun sync(context: Context, settingsRepository: SettingsRepository) = withContext(Dispatchers.IO) {
        ...
        val urlStr = "https://raw.githubusercontent.com/arpitnnd/Tidy/main/blocklist/trackers.json"
