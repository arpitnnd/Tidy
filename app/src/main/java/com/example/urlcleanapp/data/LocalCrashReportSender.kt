...
class LocalCrashReportSender : ReportSender {
    override fun send(context: Context, errorContent: CrashReportData) {
        try {
            ...
            val appVersionName = errorContent.getString(org.acra.ReportField.APP_VERSION_NAME) ?: "Unknown"
            val appVersionCode = errorContent.getString(org.acra.ReportField.APP_VERSION_CODE) ?: "Unknown"
            val androidVersion = errorContent.getString(org.acra.ReportField.ANDROID_VERSION) ?: "Unknown"
            val phoneModel = errorContent.getString(org.acra.ReportField.PHONE_MODEL) ?: "Unknown"
            val stackTrace = errorContent.getString(org.acra.ReportField.STACK_TRACE) ?: "No stacktrace"
